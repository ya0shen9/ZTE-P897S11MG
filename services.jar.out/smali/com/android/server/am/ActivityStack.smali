...
.method private completeResumeLocked(Lcom/android/server/am/ActivityRecord;)V
    ...
    .line 1036
    iput-object v2, p1, Lcom/android/server/am/ActivityRecord;->results:Ljava/util/ArrayList;

    .line 1037
    iput-object v2, p1, Lcom/android/server/am/ActivityRecord;->newIntents:Ljava/util/ArrayList;
    ...
    .line 1062
    :goto_0
    sget-boolean v1, Lcom/android/server/am/ActivityStack;->bReg:Z

    if-nez v1, :cond_1

    .line 1063
    iget-object v1, p0, Lcom/android/server/am/ActivityStack;->filter:Landroid/content/IntentFilter;
    ...
    iget-object v2, p0, Lcom/android/server/am/ActivityStack;->mReceiver:Landroid/content/BroadcastReceiver;

    iget-object v3, p0, Lcom/android/server/am/ActivityStack;->filter:Landroid/content/IntentFilter;
    ...
    sput-boolean v1, Lcom/android/server/am/ActivityStack;->bReg:Z
    ...
    sput-object v1, Lcom/android/server/am/ActivityStack;->phoneVersion:Ljava/lang/String;

    .line 1073
    :cond_1
    const-string v1, "1"

    const-string v2, "persist.sys.ztelog.user"
    ...
    .line 1075
    sget-boolean v1, Lcom/android/server/am/ActivityStack;->bScreenOn:Z
    ...
    sput-wide v1, Lcom/android/server/am/ActivityStack;->appBeginTime:J
    ...
    sput-object v1, Lcom/android/server/am/ActivityStack;->pkgName:Ljava/lang/String;
    ...
    sput-object v1, Lcom/android/server/am/ActivityStack;->actName:Ljava/lang/String;
    ...
    sput-wide v1, Lcom/android/server/am/ActivityStack;->tmpTime:J
    ...
    .line 1079
    :cond_6
    sget-object v1, Lcom/android/server/am/ActivityStack;->pkgName:Ljava/lang/String;

    invoke-virtual {p0, v1}, Lcom/android/server/am/ActivityStack;->blackRecords(Ljava/lang/String;)Z
    ...
    sget-object v3, Lcom/android/server/am/ActivityStack;->actName:Ljava/lang/String;
    ...
    sget-wide v3, Lcom/android/server/am/ActivityStack;->tmpTime:J
    ...
    sget-object v3, Lcom/android/server/am/ActivityStack;->pNo:Ljava/lang/String;

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    sget-object v3, Lcom/android/server/am/ActivityStack;->phoneVersion:Ljava/lang/String;
    ...
    invoke-direct {p0, v1, v2}, Lcom/android/server/am/ActivityStack;->getPkgLabelsName(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-wide v3, Lcom/android/server/am/ActivityStack;->appBeginTime:J
...
.method findActivityLocked(Landroid/content/Intent;Landroid/content/pm/ActivityInfo;)Lcom/android/server/am/ActivityRecord;
    ...
    iget-object v8, p2, Landroid/content/pm/ComponentInfo;->packageName:Ljava/lang/String;
...
.method final moveTaskToFrontLocked(Lcom/android/server/am/TaskRecord;Lcom/android/server/am/ActivityRecord;Landroid/os/Bundle;)V
    ...
    iput-boolean v8, v3, Lcom/android/server/am/TaskRecord;->mOnTopOfHome:Z
    ...
    const-string v5, "set mOnTopOfHome true:"
    ...
    invoke-virtual {v3, v7, v7}, Lcom/android/server/wm/WindowManagerService;->prepareAppTransition(IZ)V
...
.method final resumeTopActivityLocked(Lcom/android/server/am/ActivityRecord;Landroid/os/Bundle;)Z
    ...
    const-string v3, "am_resume_activity call stack"
...
.method final startPausingLocked(ZZ)V
    ...
    const-string v6, "am_pause_activity call stack"
