.class public Lcom/android/internal/telephony/cdma/sms/ZteBearerData;
.super Ljava/lang/Object;
.source "ZteBearerData.java"
...
.method public static decode([B)Lcom/android/internal/telephony/cdma/sms/BearerData;
    ...
    invoke-static {p0, v0}, Lcom/android/internal/telephony/cdma/sms/ZteBearerData;->decode([BI)Lcom/android/internal/telephony/cdma/sms/BearerData;
...
.method public static decode([BI)Lcom/android/internal/telephony/cdma/sms/BearerData;
    ...
    .end local v1           #decodeSuccess:Z
    :pswitch_13
    invoke-static {v0, v4}, Lcom/android/internal/telephony/cdma/sms/ZteBearerData;->decodeServiceCategoryProgramData(Lcom/android/internal/telephony/cdma/sms/BearerData;Lcom/android/internal/util/BitwiseInputStream;)Z
    ...
    .line 412
    invoke-static {v0, p1}, Lcom/android/internal/telephony/cdma/sms/ZteBearerData;->decodeCmasUserData(Lcom/android/internal/telephony/cdma/sms/BearerData;I)V
    ...
    invoke-static {v7, v8}, Lcom/android/internal/telephony/cdma/sms/ZteBearerData;->decodeUserDataPayload(Lcom/android/internal/telephony/cdma/sms/UserData;Z)V
    :try_end_2
...
.method public static decode([BZI)Lcom/android/internal/telephony/cdma/sms/BearerData;
    ...
    const-string v9, "decode  subparamId: "
    ...
    .line 455
    :pswitch_2
    invoke-static {v0, v4, p2}, Lcom/android/internal/telephony/cdma/sms/ZteBearerData;->decodeUserData(Lcom/android/internal/telephony/cdma/sms/BearerData;Lcom/android/internal/util/BitwiseInputStream;I)Z
    ...
    invoke-static {v7}, Lcom/android/internal/telephony/cdma/sms/ZteBearerData;->decodeCmasUserDataPayload(Lcom/android/internal/telephony/cdma/sms/UserData;)V
    ...
    const-string v8, " decode entry else "
...
.method static decode7bitAscii([BII)Ljava/lang/String;
    .locals 13
    .parameter "data"
    .parameter "offset"
    .parameter "numFields"
...
.method public static decode7bitAsciiEms([BII)Ljava/lang/String;
    ...
    .line 182
    .local v2, fill_bits:I
    mul-int/lit8 v9, p1, 0x8

    add-int/lit8 v9, v9, 0x6

    div-int/lit8 v6, v9, 0x7
    ...
    .line 214
    .end local v2           #fill_bits:I
    .end local v4           #inStream:Lcom/android/internal/util/BitwiseInputStream;
    .end local v5           #strBuf:Ljava/lang/StringBuffer;
    .end local v6           #udhSeptets:I
    .end local v7           #udhoffset:I
    ...
    .line 198
    .end local v1           #ex:Lcom/android/internal/util/BitwiseInputStream$AccessException;
    .restart local v2       #fill_bits:I
    .restart local v4       #inStream:Lcom/android/internal/util/BitwiseInputStream;
    .restart local v5       #strBuf:Ljava/lang/StringBuffer;
    .restart local v6       #udhSeptets:I
    .restart local v7       #udhoffset:I
...
.method private static decodeCmasUserData(Lcom/android/internal/telephony/cdma/sms/BearerData;I)V
    ...
    invoke-static {v7, v0}, Lcom/android/internal/telephony/cdma/sms/ZteBearerData;->decodeUserDataPayload(Lcom/android/internal/telephony/cdma/sms/UserData;Z)V
...
.method private static decodeServiceCategoryProgramData(Lcom/android/internal/telephony/cdma/sms/BearerData;Lcom/android/internal/util/BitwiseInputStream;)Z
    ...
    invoke-static/range {v16 .. v17}, Lcom/android/internal/telephony/cdma/sms/ZteBearerData;->decodeUserDataPayload(Lcom/android/internal/telephony/cdma/sms/UserData;Z)V
...
.method public static decodeUserData(Lcom/android/internal/telephony/cdma/sms/BearerData;Lcom/android/internal/util/BitwiseInputStream;I)Z
    .locals 8
    .parameter "bData"
    .parameter "inStream"
    .parameter "teleService"
    ...
    const-string v5, "zx @@@@@@@@@ decodeUserData new teleService ="
    ...
    const-string v5, "decodeUserData Rx1: "
...
.method private static decodeUserDataPayload(Lcom/android/internal/telephony/cdma/sms/UserData;Z)V
    ...
    invoke-static {v6, v3, v7}, Lcom/android/internal/telephony/cdma/sms/ZteBearerData;->decode7bitAsciiEms([BII)Ljava/lang/String;
    ...
    invoke-static {v6, v3, v7}, Lcom/android/internal/telephony/cdma/sms/ZteBearerData;->decode7bitAscii([BII)Ljava/lang/String;
    ...
    invoke-static {v6, v3, v7}, Lcom/android/internal/telephony/cdma/sms/ZteBearerData;->decodeUtf16Ems([BII)Ljava/lang/String;
...
.method private static decodeUtf16Ems([BII)Ljava/lang/String;
    .locals 5
    .parameter "data"
    .parameter "offset"
    .parameter "numFields"
...
.method public static encode7bitEms(Lcom/android/internal/telephony/cdma/sms/UserData;[BZ)V
    .locals 12
    .parameter "uData"
    .parameter "udhData"
    .parameter "force"
    ...
    rem-int/lit8 v1, v8, 0x7

    .line 77
    .local v1, fill_bits:I
    const/4 v3, 0x0
    ...
    invoke-static {v5, v0, v8}, Lcom/android/internal/telephony/cdma/sms/ZteBearerData;->packSmsChar([BII)V
