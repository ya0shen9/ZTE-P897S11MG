...
.method private startVoiceBasedInteractions(Z)V
    ...
    .line 1007
    iget-object v12, p0, Landroid/media/MediaFocusControl;->mContext:Landroid/content/Context;
    ...
    const-string/jumbo v13, "zte.com.cn.driverMode"
    ...
    const-string/jumbo v11, "zte.com.cn.driverMode is running, return here."
    ...
    .line 1024
    .local v7, pm:Landroid/os/PowerManager;
    iget-object v12, p0, Landroid/media/MediaFocusControl;->mKeyguardManager:Landroid/app/KeyguardManager;
    ...
    .end local v9           #voiceIntent:Landroid/content/Intent;
    const-string v10, "android.speech.action.WEB_SEARCH"

    invoke-direct {v9, v10}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .line 1027
    .restart local v9       #voiceIntent:Landroid/content/Intent;
    const-string v10, "MediaFocusControl"

    const-string/jumbo v11, "voice-based interactions: about to use ACTION_WEB_SEARCH"
    ...
    .line 1036
    iget-object v10, p0, Landroid/media/MediaFocusControl;->mMediaEventWakeLock:Landroid/os/PowerManager$WakeLock;
    ...
    invoke-virtual {v10, v9, v11}, Landroid/content/Context;->startActivityAsUser(Landroid/content/Intent;Landroid/os/UserHandle;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .end local v9           #voiceIntent:Landroid/content/Intent;
    const-string v12, "android.speech.action.VOICE_SEARCH_HANDS_FREE"

    invoke-direct {v9, v12}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .line 1030
    .restart local v9       #voiceIntent:Landroid/content/Intent;
    const-string v12, "android.speech.extras.EXTRA_SECURE"

    if-eqz v6, :cond_7

    iget-object v13, p0, Landroid/media/MediaFocusControl;->mKeyguardManager:Landroid/app/KeyguardManager;
    ...
    const-string/jumbo v11, "voice-based interactions: about to use ACTION_VOICE_SEARCH_HANDS_FREE"
    ...
    const-string v12, "No activity for search: "
    ...
    .line 1050
    iget-object v11, p0, Landroid/media/MediaFocusControl;->mMediaEventWakeLock:Landroid/os/PowerManager$WakeLock;
