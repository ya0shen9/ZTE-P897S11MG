...
.method setModeInt(ILandroid/os/IBinder;I)I
    ...
    const-string/jumbo v20, "setModeInt enter mode = "
    ...
    const-string/jumbo v19, "setModeInt() called with null binder"
    ...
    .line 1730
    .local v12, iter1:Ljava/util/Iterator;
    :goto_1
    ...
    const-string/jumbo v20, "setModeInt SetModeDeathHandler: h.mPide = "
    ...
    const-string/jumbo v20, "setModeInt SetModeDeathHandler remove: hdlr.mPid = "
    ...
    const-string/jumbo v20, "setModeInt mode is MODE_NORMAL so get mode from top of the list instead: mode = "
    ...
    const-string/jumbo v20, "setModeInt mode = "
    ...
    .line 1787
    .local v13, iter2:Ljava/util/Iterator;
    :cond_6
    :goto_3
    ...
    const-string/jumbo v20, "setModeInt SetModeDeathHandler remove: hdlr1.mPid = "
    ...
    const-string v20, " whose mode is "

    invoke-virtual/range {v19 .. v20}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v19

    const-string v20, ", hdlr1.getMode() = "
    ...
    const-string v20, " when someone set mode to MODE_IN_COMMUNICATION"
    ...
    .end local v13           #iter2:Ljava/util/Iterator;
    :cond_8
    if-nez v7, :cond_9
    ...
    const-string/jumbo v20, "setModeInt SetModeDeathHandler add: hdlr.mPid = "
    ...
    const-string/jumbo v20, "setMode() could not link to "
    ...
    .restart local v13       #iter2:Ljava/util/Iterator;
    :cond_a
    if-eqz v10, :cond_b
    ...
    invoke-static/range {v18 .. v18}, Landroid/media/AudioSystem;->setPhoneState(I)I
    ...
    const-string/jumbo v19, "setModeInt setPhoneState to MODE_NORMAL because isModeInCallOrRingToneExists is true"
    ...
    const-string/jumbo v19, "setMode() different from MODE_NORMAL with empty mode client stack"
    ...
    const-string v20, "YINQIAN, setModeInt 1 streamType:"
    ...
    const-string v20, ",getRingerMode():"
    ...
    check-cast v18, Landroid/media/AudioService$SetModeDeathHandler;

    invoke-virtual/range {v18 .. v18}, Landroid/media/AudioService$SetModeDeathHandler;->getPid()I
