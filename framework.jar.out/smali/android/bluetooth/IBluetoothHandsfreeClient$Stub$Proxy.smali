.class Landroid/bluetooth/IBluetoothHandsfreeClient$Stub$Proxy;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Landroid/bluetooth/IBluetoothHandsfreeClient$Stub;
.end annotation
...
.method constructor <init>(Landroid/os/IBinder;)V
    ...
    .line 478
    iput-object p1, p0, Landroid/bluetooth/IBluetoothHandsfreeClient$Stub$Proxy;->mRemote:Landroid/os/IBinder;
...
.method public acceptCall(Landroid/bluetooth/BluetoothDevice;I)Z
    ...
    :try_start_0
    const-string v4, "android.bluetooth.IBluetoothHandsfreeClient"
    ...
    .line 808
    iget-object v4, p0, Landroid/bluetooth/IBluetoothHandsfreeClient$Stub$Proxy;->mRemote:Landroid/os/IBinder;
...
.method public asBinder()Landroid/os/IBinder;
    ...
    .prologue
    .line 482
    iget-object v0, p0, Landroid/bluetooth/IBluetoothHandsfreeClient$Stub$Proxy;->mRemote:Landroid/os/IBinder;
...
.method public connectAudio()Z
    ...
    .local v1, _reply:Landroid/os/Parcel;
    :try_start_0
    const-string v3, "android.bluetooth.IBluetoothHandsfreeClient"

    invoke-virtual {v0, v3}, Landroid/os/Parcel;->writeInterfaceToken(Ljava/lang/String;)V

    .line 1094
    iget-object v3, p0, Landroid/bluetooth/IBluetoothHandsfreeClient$Stub$Proxy;->mRemote:Landroid/os/IBinder;
...
.method public getCurrentCalls(Landroid/bluetooth/BluetoothDevice;)Ljava/util/List;
    ...
    .line 756
    sget-object v3, Landroid/bluetooth/BluetoothHandsfreeClientCall;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    .line 759
    .local v2, _result:Ljava/util/List;,"Ljava/util/List<Landroid/bluetooth/BluetoothHandsfreeClientCall;>;"
    invoke-virtual {v1}, Landroid/os/Parcel;->recycle()V
    ...
    .line 752
    .end local v2           #_result:Ljava/util/List;,"Ljava/util/List<Landroid/bluetooth/BluetoothHandsfreeClientCall;>;"
    :cond_0
    const/4 v3, 0x0
