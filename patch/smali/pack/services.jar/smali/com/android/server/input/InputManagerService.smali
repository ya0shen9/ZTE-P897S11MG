...
.field private static final MSG_CANCEL_EXTERNAL_DEVICE_NOTIFICATION:I = 0x6
...
.method static synthetic access$600(Lcom/android/server/input/InputManagerService;I)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/input/InputManagerService;
    .param p1, "x1"    # I
    ...
    .prologue
    .line 96
    invoke-direct {p0, p1}, Lcom/android/server/input/InputManagerService;->cancelNotify(I)V
...
.method private cancelNotify(I)V
    .locals 3
    .param p1, "resId"    # I
...
.method private deliverInputDevicesChanged([Landroid/view/InputDevice;)V
    ...
    const-string v13, "inputDevice.source="
    ...
    const-string v13, ",inputDevice.id="
    ...
    const-string v13, ", inputDevice.descriptor="
...
.method private doNotify(I)V
    ...
    invoke-virtual {v3, v4, p1, v1, v5}, Landroid/app/NotificationManager;->notifyAsUser(Ljava/lang/String;ILandroid/app/Notification;Landroid/os/UserHandle;)V
    ...
    invoke-virtual {v3, v4, p1, v5}, Lcom/android/server/input/InputManagerService$InputManagerHandler;->obtainMessage(III)Landroid/os/Message;
    ...
    invoke-virtual {v3, v0, v4, v5}, Lcom/android/server/input/InputManagerService$InputManagerHandler;->sendMessageDelayed(Landroid/os/Message;J)Z
...
.method private hideMissingKeyboardLayoutNotification()V
    ...
    .line 785
    iput-boolean v7, p0, Lcom/android/server/input/InputManagerService;->mKeyboardLayoutNotificationShown:Z
    ...
    invoke-virtual {v3, v8, v4, v5}, Landroid/app/NotificationManager;->cancelAsUser(Ljava/lang/String;ILandroid/os/UserHandle;)V
    ...
    invoke-virtual {v3, v8, v6, v1, v4}, Landroid/app/NotificationManager;->notifyAsUser(Ljava/lang/String;ILandroid/app/Notification;Landroid/os/UserHandle;)V
    ...
    invoke-virtual {v3, v4, v6, v7}, Lcom/android/server/input/InputManagerService$InputManagerHandler;->obtainMessage(III)Landroid/os/Message;
...
.method public updateExternalDeviceNotification(I)V
    ...
    const-string v2, "updateExternalDeviceNotification() id="
    ...
    .line 738
    :pswitch_0
    invoke-direct {p0, v4}, Lcom/android/server/input/InputManagerService;->cancelNotify(I)V

    .line 739
    invoke-direct {p0, v3}, Lcom/android/server/input/InputManagerService;->doNotify(I)V

    goto :goto_0

    .line 742
    :pswitch_1
    invoke-direct {p0, v3}, Lcom/android/server/input/InputManagerService;->cancelNotify(I)V

    .line 743
    invoke-direct {p0, v4}, Lcom/android/server/input/InputManagerService;->doNotify(I)V
