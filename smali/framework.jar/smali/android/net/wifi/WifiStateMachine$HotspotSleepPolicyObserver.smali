...
.method public onChange(Z)V
    ...
    invoke-static {v1}, Landroid/net/wifi/WifiStateMachine;->access$29200(Landroid/net/wifi/WifiStateMachine;)Landroid/app/PendingIntent;
    ...
    invoke-static {v1}, Landroid/net/wifi/WifiStateMachine;->access$14300(Landroid/net/wifi/WifiStateMachine;)Landroid/app/AlarmManager;
    ...
    # getter for: Landroid/net/wifi/WifiStateMachine;->mHotspotSleepIntent:Landroid/app/PendingIntent;
    invoke-static {v3}, Landroid/net/wifi/WifiStateMachine;->access$29200(Landroid/net/wifi/WifiStateMachine;)Landroid/app/PendingIntent;
    ...
    invoke-static {v1, v3}, Landroid/net/wifi/WifiStateMachine;->access$29302(Landroid/net/wifi/WifiStateMachine;I)I
    ...
    invoke-static {v4}, Landroid/net/wifi/WifiStateMachine;->access$29300(Landroid/net/wifi/WifiStateMachine;)I
    ...
    invoke-static {v4}, Landroid/net/wifi/WifiStateMachine;->access$27100(Landroid/net/wifi/WifiStateMachine;)Z
    ...
    invoke-static {v1, v3}, Landroid/net/wifi/WifiStateMachine;->access$29400(Landroid/net/wifi/WifiStateMachine;Ljava/lang/String;)V
    ...
    # getter for: Landroid/net/wifi/WifiStateMachine;->mHotspotConnStaCounter:I
    invoke-static {v1}, Landroid/net/wifi/WifiStateMachine;->access$29300(Landroid/net/wifi/WifiStateMachine;)I
    ...
    # getter for: Landroid/net/wifi/WifiStateMachine;->mHotspotshouldSleep:Z
    invoke-static {v1}, Landroid/net/wifi/WifiStateMachine;->access$27100(Landroid/net/wifi/WifiStateMachine;)Z
    ...
    # getter for: Landroid/net/wifi/WifiStateMachine;->mHotspotSleepIntent:Landroid/app/PendingIntent;
    invoke-static {v6}, Landroid/net/wifi/WifiStateMachine;->access$29200(Landroid/net/wifi/WifiStateMachine;)Landroid/app/PendingIntent;
